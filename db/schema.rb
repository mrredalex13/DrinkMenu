...
ActiveRecord::Schema.define(version: 2023_03_18_220052) do
  ...
  create_table "drink_ingredients", force: :cascade do |t|
    ...
    t.index ["drink_id", "ingredient_id"], name: "index_drink_ingredients_on_drink_id_and_ingredient_id", unique: true
